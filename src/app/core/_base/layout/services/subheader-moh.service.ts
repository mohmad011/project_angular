...
// Services
import { PageMohConfigService } from './page-moh-config.service';
import { MenuMohConfigService } from './menu-moh-config.service';
...
@Injectable()
export class SubheaderMohService {
	// Public properties
  ...
  private asideMenus: any;
	 ...
	 *
	 * @param router: Router
	 * @param pageMohConfigService: PageMohConfigService
	 * @param menuMohConfigService: MenuMohConfigService
	 */
	constructor(
		...
		const initBreadcrumb = () => {
			...
			this.pageConfig = this.pageMohConfigService.getCurrentPageConfig();
			this.headerMenus = objectPath.get(this.menuMohConfigService.getMenus(), 'header');
			this.asideMenus = objectPath.get(this.menuMohConfigService.getMenus(), 'aside');
	...
	getBreadcrumbs(menus: any) {
		let url = this.pageMohConfigService.cleanUrl(this.router.url);

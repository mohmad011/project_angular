...
export class MenuHorizontalComponent implements OnInit, AfterViewInit {
	...
	rootArrowEnabled1: boolean;
	rootArrowEnabled2: boolean;
	 ...
	 */
	ngOnInit(): void {
		this.rootArrowEnabled1 = this.layoutConfigService.getConfig('header.menu.self.root-arrow');
		this.rootArrowEnabled2 = this.layoutMohConfigService.getConfig('header.menu.self.root-arrow');

...
export class AdminsListComponent extends baseListComponent<Admin> implements OnInit, OnDestroy {
	...
	constructor(
		...
		super(activatedRoute, router, layoutUtilsService ,subheaderService, null, translate);
